...
class ResultsFrame(ctk.CTkScrollableFrame):
    ...
    def search_update(self, *args):
        ...
        for i in range(0, len(self.toDisplay)):
            ...
            self.change_music_dict[i] = ctk.CTkButton(self.toDisplayDict[i], text='+', command=lambda id=self.toDisplay[i][1]: self.change_song_id(id), width=10, height=10)
